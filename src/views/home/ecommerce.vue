      ...
      return {
        ...
        chartOptions: {
          ...
          legend: {
            ...
            labels: {
              colors: this.$store.state.isDark ? "#CBD5E1" : "#475569",
            },
            itemMargin: {
              horizontal: 18,
              vertical: 0,
          ...
          title: {
            ...
            offsetX: this.$store.getters.direction ? "0%" : 0,
            offsetY: 13,
            floating: false,
            style: {
              fontSize: "20px",
              fontWeight: "500",
              fontFamily: "Inter",
              color: this.$store.state.isDark ? "#fff" : "#0f172a",
            },
          },
          dataLabels: {
            enabled: false,
          ...
          yaxis: {
            opposite: this.$store.getters.direction ? true : false,
            labels: {
              style: {
                colors: this.$store.state.isDark ? "#CBD5E1" : "#475569",
                fontFamily: "Inter",
